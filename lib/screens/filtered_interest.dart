...
import 'package:hackerton/widgets/feedWidget.dart';
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: const [
                    Text(
                      "Your Interest",
                      style: TextStyle(color: Color.fromRGBO(161, 103, 165, 1)),
                    ),
                    Text("View All",
                        style:
                            TextStyle(color: Color.fromRGBO(161, 103, 165, 1)))
                  ],
                ),
              ),
                  ...
                  child: Row(
                    children: INTERESTS
                        .map((element) => Container(
                              color: const Color.fromRGBO(161, 103, 165, 1),
